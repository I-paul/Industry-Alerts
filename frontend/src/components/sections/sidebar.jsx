...
const Sidebar = ({ setDept, dept }) => {
    ...
    return (
        <motion.section className="hidden md:flex flex-col sticky h-[90vh] w-[20vw] top-20 right-0 bg-[var(--brand-primary)] border-r-4 border-b-4 border-[var(--brand-secondary)] p-8 gap-1 rounded-br-4xl 
                                    justify-around text-[11px] lg:text-[16px] "
