...
const variantClasses ={
    Navbar : 'text-white text-lg font-bold hover:scale-[1.1] hover:bg-[var(--brand-accent)] hover:text-[var(--brand-primary)] duration-[0.5s] ease-in-out transition  rounded-r-xl',
